...
export const arOverrides: DeepPartial<Content> = {
  ...
  ambition: {
    eyebrow: "طموحنا",
    statement:
      "أن نصبح الاسم الأكثر ثقة في مجال الهواء النظيف في دول الخليج، ونحمي الأرواح ونرتقي بالبيئات في كل منزل ومدرسة ومكتب وفندق ومطار في المنطقة.",
  },
  ...
  devices: [
    ...
    },
    {
      ...
      summary:
        "النظام بالكامل في وحدة يمكن حملها. بدون تركيب، وبدون مجاري هواء، وبدون التزام، فكل ما تحتاجه مقبس كهربائي.",
    },
    {
